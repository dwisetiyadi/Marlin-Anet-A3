...
#define STRING_CONFIG_H_AUTHOR "(Dwi Setiyadi, Anet A3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anet A3"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.1, 100.9, 402, 97.4 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0324 // (mm) Distance from real junction edge
#endif
...
#define Z_MAX_POS Z_BED_SIZE + Z_MIN_POS
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BKGD_LED_INDEX  15               // Index of the LED to use
